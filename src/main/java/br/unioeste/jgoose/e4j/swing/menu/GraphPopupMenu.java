...
/*    */
 ...
 /*    */ public GraphPopupMenu(BasicGraphEditor editor) /*    */ {
        ...
        /*    */
 /*    */
        if ((editor instanceof br.unioeste.jgoose.e4j.swing.BasicIStarEditor)) {
            add(editor.bind(mxResources.get("addBoundary", "Add Boundary"), new br.unioeste.jgoose.e4j.actions.AddBoundary()));
            addSeparator();
        } else if (editor instanceof br.unioeste.jgoose.e4j.swing.BasicBPMNEditor) {
            add(editor.bind(mxResources.get("addLane", "Add Lane"), new br.unioeste.jgoose.e4j.actions.AddLane()));
            add(editor.bind(mxResources.get("collapseOrExpand", "Enable Collapse/Expand Sub-process"), new br.unioeste.jgoose.e4j.actions.ExpandOrCollapseSubprocess()));
        }
        /*    */
